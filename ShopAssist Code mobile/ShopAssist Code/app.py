...
from functions import (
    initialize_conversation, initialize_conv_reco, get_chat_model_completions, moderation_check,
    intent_confirmation_layer, dictionary_present, compare_laptops_with_user, recommendation_validation
)
import openai
import ast
import re
...
def invite():
    ...
    prompt = 'Remember your system message and that you are an intelligent Mobile assistant. So, you only help with questions around Mobiles'
    
    # Check for moderation flag on user input
    ...
    if top_3_laptops is None:
        ...
        # Check for moderation flag on assistant response
        moderation = moderation_check(response_assistant)
        if moderation == 'Flagged':
            return redirect(url_for('end_conv'))
        print("%%%%%%%%%               befor confirmation the response is               %%%%%%%%%%%%%%%%%%")
        ...
        if "No" in confirmation:
            ...
            print("%%%%%%%%%%%%%%%%%%%%%%%")
            print("laptop recomendation function was hit")
            ...
            if len(validated_reco) == 0:
                conversation_bot.append({'bot': "Sorry, we do not have Mobiles that match your requirements. Connecting you to a human expert. Please end this conversation."})
